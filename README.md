...
Лабораторія для збірки й запуску віртуальних машин на локальному хості: усе відтворюється з коду, тому машину можна вільно ламати, зносити й швидко піднімати заново.
