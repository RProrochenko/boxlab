...
Суфікс виконує подвійну роль: для Vagrant це частина імені машини (`ubuntu26-test1`), а всередині гостьової ОС — її `hostname` (`test1`). Базовий `hostname` з `machines/<os>/machine.json` дістається лише машині без суфікса.
